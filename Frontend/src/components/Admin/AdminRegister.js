  ...
  const handleSubmit = async (e) => {
    ...
    if (name === '' || email === '' || password === '') {
      ...
      navigate("/adminregister");
        ...
        let admindata =  await CreateAdmin(newdata);
        ...
        {   Swal.fire('Congrats' , 'Successfully create Admin Account ' , 'success')
        navigate("/AdminRegister");
          }
    }
  };
  ...
  return (
    <div >
      ...
      <div style={{marginTop:"30px"}}>
          <center><h1 style={{"font-family": 'Chilanka'}} ><b>Welcome to  Research Project Management Tool Admin panel </b></h1></center> 
        </div>
        <br/>
