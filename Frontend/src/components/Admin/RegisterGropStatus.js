...
<br></br><br></br>
        <table className="table table-bordered " style={{marginLeft:"240px" , marginTop:"-20px"}}>
          <thead className="bs">
            <tr>
              <th style={{color:"black" , backgroundColor:"yellow"}}>Gruop Leader Email</th>
              <th  style={{color:"black" , backgroundColor:"yellow"}}  >GruopLeader ItNumber</th>
              <th  style={{color:"black" , backgroundColor:"yellow"}} >GruopMembers ItNumbers</th>
              <th style={{color:"black" , backgroundColor:"yellow"}} >GruopMembers Names</th>
               <th style={{color:"black" , backgroundColor:"yellow"}} >GroupID </th>
              <th style={{color:"black" , backgroundColor:"yellow"}} > Assign GroupID </th>
              <th style={{color:"black" , backgroundColor:"yellow"}} >send email  </th>
            </tr>
          </thead>
           ...
           .map((user) => {
                return (
                  <tr>
                    ...
                    <td>  <Link to ={{pathname:`/updateGroupsByID/${user?._id}`}}>
                                    <button  type="button"  className="btn btn-outline-success" style={{marginTop:'10px'}} > Assign GroupID </button>
                                    </Link>&nbsp;</td>




                                    <td>  <Link to ={{pathname:`/updateGroupsIDByID/${user?._id}`}}>
                                    <button  type="button"  className="btn btn-outline-success" style={{marginTop:'10px'}} > Send Group Register Status To  Students  </button>
                                    </Link>&nbsp;</td>
...
export default RegisterGropStatus;
