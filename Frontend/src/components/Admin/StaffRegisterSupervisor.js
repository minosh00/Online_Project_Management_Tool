...
import {CreateStaffSupervisor} from '../../services/AuthServices';
import Swal from "sweetalert2";
import logo from '../images/admin.jpg'
import '../ClientLogin.css'

const StaffRegisterSupervisor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (name === '' || email === '' || password === '') {
      ...
      navigate("/StaffRegister");
        ...
        let admindata =  await CreateStaffSupervisor(newdata);
        ...
        {   Swal.fire('Congrats' , 'Successfully create Staff Account ' , 'success')
...
export default StaffRegisterSupervisor;
