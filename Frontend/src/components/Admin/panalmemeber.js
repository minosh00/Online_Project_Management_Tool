...
import {CreateStaffPanelMember} from '../../services/AuthServices';
  ...
  const handleSubmit = async (e) => {
    ...
    if (name === '' || email === '' || password === '') {
      ...
      navigate("/CoSupervisor");
        ...
        let admindata =  await CreateStaffPanelMember(newdata);
        ...
        {   Swal.fire('Congrats' , 'Successfully create PanelMember Account ' , 'success')
        navigate("/CoSupervisor");
          }
    }
  };
                   ...
                   <form >
                       <div className="row d-flex">
                           ...
                           <div className="col-lg-6">
                               ...
                               <h1>Panal Memeber Registration </h1>
                               <br></br>
