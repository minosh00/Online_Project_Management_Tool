...
import { Link } from "react-router-dom";
 ...
 const AllPnaelMembersInterface = () => {
...
<a style={{ display: localStorage.getItem("userRole") == "Admin" ? "flex" : "none" }} className="nav-link active" href="/StudentProfile" aria-current="page">Admin Profile</a>
         ...
         <h1>Welcome to the panel members Home page</h1>
            <br />
            <br />
		<br/>
...
<div class="row row-cols-1 row-cols-md-3">
  <div class="col mb-4">
    ...
    <img src={avatar} alt="" width={"90%"} height={"90%"} />
      <div class="card-body">
        ...
        <p class="card-text">Evaluate Topics in student .</p>
        <Link  to="/AllTopicsPnelMmeber">
  ...
  <div class="col mb-4">
    <div class="card">
    <img src={avatar2} alt="" width={"45%"} height={"45%"} />
      <div class="card-body">
      <h5 class="card-title">Evaluate Assignment Student presentations</h5>
        <p class="card-text">Evaluate Topics in student .</p>
...
export default AllPnaelMembersInterface;