 ...
 function DisplaySuperviorStatus() {
   ...
   useEffect(async () => {
     ...
     try {
       const data = await (
         await axios.get("https://afresearchprojectmanagementtoo.herokuapp.com/SupervisorRequest/AllSupervicorRequestStatus/")
       ).data;
 ...
 <br/>
     ...
     <div className="row">
       ...
       <div className="col-md-9">
         ...
         <center><h1>SupervisorRequest Approved  Status</h1></center>
 ...
 export default DisplaySuperviorStatus;
