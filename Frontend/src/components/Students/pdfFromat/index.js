...
const SongForm = () => {
	...
	const handleSubmit = async (e) => {
		e.preventDefault()
		try {
			const url = 'https://afresearchprojectmanagementtoo.herokuapp.com/UploadAssignment/assigment'
			const { data : res } = await axios.post(url, data);

			{   Swal.fire('Congrats' , 'Successfully Upload Your Assignment ' , 'success')
		...
		<div className={styles.container}>
			<form className={styles.form} onSubmit={handleSubmit} >
				...
				<input
					...
					placeholder="Assignments ID/ GroupID"
					name="name"
